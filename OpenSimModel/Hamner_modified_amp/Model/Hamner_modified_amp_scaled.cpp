...
int F_generic(const T** arg, T** res) {
	...
	tibia_r = new OpenSim::Body("tibia_r", 1.98780077323633808106, Vec3(0.00000000000000000000, -0.18056859165036664994, 0.00000000000000000000), Inertia(0.01555480000000000057, 0.00157400000000000010, 0.01577084000000000125, 0., 0., 0.));
	model->addBody(tibia_r);

	OpenSim::Body* talus_r;
	talus_r = new OpenSim::Body("talus_r", 0.05361566482093999692, Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), Inertia(0.00027559999999999998, 0.00027559999999999998, 0.00027559999999999998, 0., 0., 0.));
	model->addBody(talus_r);

	OpenSim::Body* calcn_r;
	calcn_r = new OpenSim::Body("calcn_r", 0.67019581026174601668, Vec3(0.09139243779317623995, 0.02741773133795287129, 0.00000000000000000000), Inertia(0.00038582200000000002, 0.00107478000000000001, 0.00112990000000000009, 0., 0., 0.));
	model->addBody(calcn_r);

	OpenSim::Body* toes_r;
	toes_r = new OpenSim::Body("toes_r", 0.11613153000215499511, Vec3(0.03162178347643897908, 0.00548354626759057443, -0.01599367661380584477), Inertia(0.00002755870000000000, 0.00005511760000000000, 0.00027558720000000000, 0., 0., 0.));
	...
	tibia_l = new OpenSim::Body("tibia_l", 3.05815503574821212496, Vec3(0.00000000000000000000, -0.18056859165036664994, 0.00000000000000000000), Inertia(0.03888701977444303931, 0.00393499604860435542, 0.03942711727131030519, 0., 0., 0.));
	...
	OpenSim::Body* ulna_r;
	ulna_r = new OpenSim::Body("ulna_r", 0.50110025198032071003, Vec3(0.00000000000000000000, -0.11693148015018021979, 0.00000000000000000000), Inertia(0.00229970435155589905, 0.00047981677557783442, 0.00249458139147505208, 0., 0., 0.));
	model->addBody(ulna_r);

	OpenSim::Body* radius_r;
	radius_r = new OpenSim::Body("radius_r", 0.50110025198032071003, Vec3(0.00000000000000000000, -0.11693148015018021979, 0.00000000000000000000), Inertia(0.00229970435155589905, 0.00047981677557783442, 0.00249458139147505208, 0., 0., 0.));
	model->addBody(radius_r);

	OpenSim::Body* hand_r;
	hand_r = new OpenSim::Body("hand_r", 0.37737179470122916847, Vec3(0.00000000000000000000, -0.06606470973512983125, 0.00000000000000000000), Inertia(0.00069255107413499731, 0.00042469219456484704, 0.00104037941630145351, 0., 0., 0.));
	...
	OpenSim::Body* ulna_l;
	ulna_l = new OpenSim::Body("ulna_l", 0.50110025198032071003, Vec3(0.00000000000000000000, -0.11693148015018021979, 0.00000000000000000000), Inertia(0.00229970435155589905, 0.00047981677557783442, 0.00249458139147505208, 0., 0., 0.));
	model->addBody(ulna_l);

	OpenSim::Body* radius_l;
	radius_l = new OpenSim::Body("radius_l", 0.50110025198032071003, Vec3(0.00000000000000000000, -0.11693148015018021979, 0.00000000000000000000), Inertia(0.00229970435155589905, 0.00047981677557783442, 0.00249458139147505208, 0., 0., 0.));
	model->addBody(radius_l);

	OpenSim::Body* hand_l;
	hand_l = new OpenSim::Body("hand_l", 0.37737179470122916847, Vec3(0.00000000000000000000, -0.06606470973512983125, 0.00000000000000000000), Inertia(0.00069255107413499731, 0.00042469219456484704, 0.00104037941630145351, 0., 0., 0.));
	...
	st_knee_r[3].setFunction(new MultiplierFunction(new PolynomialFunction(st_knee_r_3_coeffs_vec), 1.00274504572764011634));
	...
	st_knee_r[4].setFunction(new MultiplierFunction(new PolynomialFunction(st_knee_r_4_coeffs_vec), 1.00274504572764011634));
	...
	st_ankle_r[3].setFunction(new MultiplierFunction(new Constant(0.00000000000000000000), 0.96715903401374736514));
	st_ankle_r[3].setAxis(Vec3(1.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000));
	st_ankle_r[4].setFunction(new MultiplierFunction(new Constant(0.00000000000000000000), 0.96715903401374736514));
	st_ankle_r[4].setAxis(Vec3(0.00000000000000000000, 1.00000000000000000000, 0.00000000000000000000));
	st_ankle_r[5].setFunction(new MultiplierFunction(new Constant(0.00000000000000000000), 0.96715903401374736514));
	...
	ankle_r = new OpenSim::CustomJoint("ankle_r", *tibia_r, Vec3(0.00000000000000000000, -0.41587838462591136812, 0.00000000000000000000), Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), *talus_r, Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), st_ankle_r);
	...
	st_knee_l[3].setFunction(new MultiplierFunction(new PolynomialFunction(st_knee_l_3_coeffs_vec), 1.00274504572764011634));
	...
	st_knee_l[4].setFunction(new MultiplierFunction(new PolynomialFunction(st_knee_l_4_coeffs_vec), 1.00274504572764011634));
	...
	st_ankle_l[3].setFunction(new MultiplierFunction(new Constant(0.00000000000000000000), 0.96715903401374736514));
	st_ankle_l[3].setAxis(Vec3(1.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000));
	st_ankle_l[4].setFunction(new MultiplierFunction(new Constant(0.00000000000000000000), 0.96715903401374736514));
	st_ankle_l[4].setAxis(Vec3(0.00000000000000000000, 1.00000000000000000000, 0.00000000000000000000));
	st_ankle_l[5].setFunction(new MultiplierFunction(new Constant(0.00000000000000000000), 0.96715903401374736514));
	...
	ankle_l = new OpenSim::CustomJoint("ankle_l", *tibia_l, Vec3(0.00000000000000000000, -0.41587838462591136812, 0.00000000000000000000), Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), *talus_l, Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), st_ankle_l);
	...
	/// YH: Passive prosthetic ankle torque at ankle_angle_r.
	auto indicesOSInSimbody_passive = getIndicesOpenSimInSimbody(*model);
	int osIndex_ankle_r = model->getCoordinateSet().getIndex("ankle_angle_r");
	int simIndex_ankle_r = indicesOSInSimbody_passive[osIndex_ankle_r];
	osim_double_adouble q_ankle_r = QsUs[osIndex_ankle_r];
	appliedMobilityForces[simIndex_ankle_r] += 0 * q_ankle_r;
	...
	/// Whole-body center of mass position and velocity.
	double total_mass = 0.0;
	Vec3 COM_pos(0.0, 0.0, 0.0);
	Vec3 COM_vel(0.0, 0.0, 0.0);

	/// Contribution from pelvis
	total_mass += 9.71433360917240484866;
	COM_pos += 9.71433360917240484866 * pelvis->getPositionInGround(*state);
	COM_vel += 9.71433360917240484866 * pelvis->getVelocityInGround(*state)[1];

	/// Contribution from femur_r
	total_mass += 7.67231915023827859557;
	COM_pos += 7.67231915023827859557 * femur_r->getPositionInGround(*state);
	COM_vel += 7.67231915023827859557 * femur_r->getVelocityInGround(*state)[1];

	/// Contribution from tibia_r
	total_mass += 1.98780077323633808106;
	COM_pos += 1.98780077323633808106 * tibia_r->getPositionInGround(*state);
	COM_vel += 1.98780077323633808106 * tibia_r->getVelocityInGround(*state)[1];

	/// Contribution from talus_r
	total_mass += 0.05361566482093999692;
	COM_pos += 0.05361566482093999692 * talus_r->getPositionInGround(*state);
	COM_vel += 0.05361566482093999692 * talus_r->getVelocityInGround(*state)[1];

	/// Contribution from calcn_r
	total_mass += 0.67019581026174601668;
	COM_pos += 0.67019581026174601668 * calcn_r->getPositionInGround(*state);
	COM_vel += 0.67019581026174601668 * calcn_r->getVelocityInGround(*state)[1];

	/// Contribution from toes_r
	total_mass += 0.11613153000215499511;
	COM_pos += 0.11613153000215499511 * toes_r->getPositionInGround(*state);
	COM_vel += 0.11613153000215499511 * toes_r->getVelocityInGround(*state)[1];

	/// Contribution from femur_l
	total_mass += 7.67231915023827859557;
	COM_pos += 7.67231915023827859557 * femur_l->getPositionInGround(*state);
	COM_vel += 7.67231915023827859557 * femur_l->getVelocityInGround(*state)[1];

	/// Contribution from tibia_l
	total_mass += 3.05815503574821212496;
	COM_pos += 3.05815503574821212496 * tibia_l->getPositionInGround(*state);
	COM_vel += 3.05815503574821212496 * tibia_l->getVelocityInGround(*state)[1];

	/// Contribution from talus_l
	total_mass += 0.08248563818606102771;
	COM_pos += 0.08248563818606102771 * talus_l->getPositionInGround(*state);
	COM_vel += 0.08248563818606102771 * talus_l->getVelocityInGround(*state)[1];

	/// Contribution from calcn_l
	total_mass += 1.03107047732576262433;
	COM_pos += 1.03107047732576262433 * calcn_l->getPositionInGround(*state);
	COM_vel += 1.03107047732576262433 * calcn_l->getVelocityInGround(*state)[1];

	/// Contribution from toes_l
	total_mass += 0.17866389231100815449;
	COM_pos += 0.17866389231100815449 * toes_l->getPositionInGround(*state);
	COM_vel += 0.17866389231100815449 * toes_l->getVelocityInGround(*state)[1];

	/// Contribution from torso
	total_mass += 22.12809221362184430859;
	COM_pos += 22.12809221362184430859 * torso->getPositionInGround(*state);
	COM_vel += 22.12809221362184430859 * torso->getVelocityInGround(*state)[1];

	/// Contribution from humerus_r
	total_mass += 1.67652059613169024388;
	COM_pos += 1.67652059613169024388 * humerus_r->getPositionInGround(*state);
	COM_vel += 1.67652059613169024388 * humerus_r->getVelocityInGround(*state)[1];

	/// Contribution from ulna_r
	total_mass += 0.50110025198032071003;
	COM_pos += 0.50110025198032071003 * ulna_r->getPositionInGround(*state);
	COM_vel += 0.50110025198032071003 * ulna_r->getVelocityInGround(*state)[1];

	/// Contribution from radius_r
	total_mass += 0.50110025198032071003;
	COM_pos += 0.50110025198032071003 * radius_r->getPositionInGround(*state);
	COM_vel += 0.50110025198032071003 * radius_r->getVelocityInGround(*state)[1];

	/// Contribution from hand_r
	total_mass += 0.37737179470122916847;
	COM_pos += 0.37737179470122916847 * hand_r->getPositionInGround(*state);
	COM_vel += 0.37737179470122916847 * hand_r->getVelocityInGround(*state)[1];

	/// Contribution from humerus_l
	total_mass += 1.67652059613169024388;
	COM_pos += 1.67652059613169024388 * humerus_l->getPositionInGround(*state);
	COM_vel += 1.67652059613169024388 * humerus_l->getVelocityInGround(*state)[1];

	/// Contribution from ulna_l
	total_mass += 0.50110025198032071003;
	COM_pos += 0.50110025198032071003 * ulna_l->getPositionInGround(*state);
	COM_vel += 0.50110025198032071003 * ulna_l->getVelocityInGround(*state)[1];

	/// Contribution from radius_l
	total_mass += 0.50110025198032071003;
	COM_pos += 0.50110025198032071003 * radius_l->getPositionInGround(*state);
	COM_vel += 0.50110025198032071003 * radius_l->getVelocityInGround(*state)[1];

	/// Contribution from hand_l
	total_mass += 0.37737179470122916847;
	COM_pos += 0.37737179470122916847 * hand_l->getPositionInGround(*state);
	COM_vel += 0.37737179470122916847 * hand_l->getVelocityInGround(*state)[1];
	...
	/// COM velocity (mediolateral component).
	res[0][103] = value<T>(COM_vel[2]);

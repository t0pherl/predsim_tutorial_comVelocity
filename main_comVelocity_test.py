...
for case in cases:    
    ...
    weights = {'metabolicEnergyRateTerm' : 500, # default.
               ...
               'passiveTorqueTerm': 2, 
               'controls': 0.001,
               'comVelocityTerm': 0} # CL added this
...
#        comVelocityTerm_opt_all = ca.DM(0) #CL ADDED
...
#                # Cost function terms.
 ...
 #               comVelocityTerm_opt = 0 #CL ADDED FIX!!!
 #               
 ...
 #                   weights['comVelocityTerm'] * comVelocityTerm_opt * 
